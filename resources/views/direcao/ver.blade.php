...
<div class="row" style="border-color:red;">
    <div class="col-8">
            <div class="card mb-3">
                    ...
                    <div class="card-body"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"></div><div class="chartjs-size-monitor-shrink"></div></div>
                        <!-- Tabela dos alunos com mais modulos por fazer -->
                        <table class="table">
                            <thead>
                                <tr>
