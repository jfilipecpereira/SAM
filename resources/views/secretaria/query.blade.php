                        ...
                        <tbody>
                                @foreach($dados as $utilizador)
                                    <tr>
                                        ...
                                        <td>{{ $utilizador['aluno'][0]['cursos']['nome_curso'] }}</td>
                                        <td>
                                            <a href="{{ route('SecretariaeditarAluno', $utilizador['id']  ) }}" class="btn btn-primary">Editar</a>

                                            <form action="{{ route('Secretariaapagar', $utilizador['id']  ) }}" method="post" style="display: inline;">
                                                @csrf
                                                @method('DELETE')
